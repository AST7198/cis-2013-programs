...
var passwordCheckOld = function () 
{
  ...
  {
      stringOutput = ("Gurl what are you doing? If it ain't 8 then it ain't great");
      $("password").value = "";
  }
  else
  {
      for(counter = 0; counter < arrayBadPasswords.length; counter++)
      {
          ...
          {
              stringOutput = ("Gurl.... thats a bad password. you basic.");
              break;
          }
          else
          {
              stringOutput = ("MATERIAL GWORL. ACT TF UP!!!!!!!")
          }
      }
  }
