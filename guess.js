...
intMax = parseInt(prompt("Please enter a numbe which is at least " + (intMin + 2) + " as your maximum number."));
...
alert("Congradulations, you guessed the random number of " + intRandom + " in only " + intCount + "attempts!!")